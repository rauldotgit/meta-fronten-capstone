    ...
    return(
        <div className="xl:w-1/2 relative grid grid-cols-2 w-3/4 gap-5 py-8">
            <div className="flex flex-col items-start col-start-1 col-end-2">
                <h1 role="heading" className="text-yellow-400 text-4xl md:text-5xl font-serif">Little Lemon</h1>
                <h2 role="heading" className="text-zinc-100 text-2xl md:text-3xl font-serif">Chicago</h2>
                <p role="complementary" className="mt-4 text-zinc-100 text-sm md:text-md xl:text-lg xl:font-thin">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae unde laudantium vel, accusantium laboriosam quia illo.</p>
