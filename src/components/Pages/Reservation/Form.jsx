...
export default function Form(props) {
    ...
    return (
        <div className="py-16 h-screen w-full bg-zinc-200 flex flex-col justify-center items-center">
            <div className="h-3/5 flex flex-col justify-between bg-white w-2/3 lg:w-1/2 xl:w-2/5 rounded-lg p-16">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col w-full">
                        ...
                        <div className="flex justify-between gap-5 mt-5">
                            <Link to="/reserve/date">
                                <button className="hover:opacity-90 active:translate-y-0.5 font-semibold rounded-md px-6 py-2 bg-little-green self-end" >Back</button>
                            </Link>
                            <button type='submit' className="w-full hover:opacity-90 active:translate-y-0.5  text-zinc-900 font-semibold rounded-md px-6 py-2 bg-little-yellow self-end" >Book Table</button>
                        </div>
                    </form>
